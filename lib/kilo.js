...
/* this is crap but jsut to test */
	...
	$('#image-1 img').replaceWith($('<img />').attr('src', 'images/' + worddatabase[wordindex[0]].toLowerCase() + '.jpg').bind("load",allLoaded));
	$('#image-1 img').bind('tap',myindex !== 0 ? function() { $('#tryagain').popup("open"); } : function() {$('#bravo').popup("open");});
	$('#image-2 img').replaceWith($('<img />').attr('src', 'images/' + worddatabase[wordindex[1]].toLowerCase() + '.jpg').bind("load",allLoaded));
	$('#image-2 img').bind('tap',myindex != 1 ? function() { $('#tryagain').popup("open"); } : function() {$('#bravo').popup("open");});
	$('#image-3 img').replaceWith($('<img />').attr('src', 'images/' + worddatabase[wordindex[2]].toLowerCase() + '.jpg').bind("load",allLoaded));
	$('#image-3 img').bind('tap',myindex != 2 ? function() { $('#tryagain').popup("open"); } : function() {$('#bravo').popup("open");});
   });
 });
});
