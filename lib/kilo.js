...
/* this is crap but jsut to test */
	...
	$('#image-1 img').bind('load', imageloaded()).attr('src', 'images/' + worddatabase[wordindex[0]].toLowerCase() + '.jpg');
	$('#image-1 img').unbind('tap').bind('tap',myindex !== 0 ? function() { $('#tryagain').popup("open"); } : function() {$('#bravo').popup("open");});
	$('#image-2 img').bind('load', imageloaded()).attr('src', 'images/' + worddatabase[wordindex[1]].toLowerCase() + '.jpg');
	$('#image-2 img').unbind('tap').bind('tap',myindex != 1 ? function() { $('#tryagain').popup("open"); } : function() {$('#bravo').popup("open");});
	$('#image-3 img').bind('load', imageloaded()).attr('src', 'images/' + worddatabase[wordindex[2]].toLowerCase() + '.jpg');
	$('#image-3 img').unbind('tap').bind('tap',myindex != 2 ? function() { $('#tryagain').popup("open"); } : function() {$('#bravo').popup("open");});
	});
 });
});
